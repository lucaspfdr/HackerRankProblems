...
int main() {
    int arr[] = {1, 3, -34, 5, -6, -6, 2, -90, -6, 5, -6, 99, -6, 156, 0, 0, -6, 15, -6, 0, -90, -62, -10, 17, 0};
    ...
    positiveFraction = static_cast<float>(positiveCount) / arrSize;
    negativeFraction = static_cast<float>(negativeCount) / arrSize;
    zeroFraction = static_cast<float>(zeroCount) / arrSize;
